...
def run_test_draw_points_on_circle():
    ...
    circle = rg.Circle(rg.Point(225, 225), 200)
    draw_points_on_circle(window, circle, 30, 'red')
    window.continue_on_mouse_click()

    circle = rg.Circle(rg.Point(225, 225), 100)
    draw_points_on_circle(window, circle, 30, 'orange')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    pizza(window, circle, 250, 'orange', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    polygon(window, circle, 6, 'blue', 5)

    circle = rg.Circle(rg.Point(300, 300), 250)
    circle.outline_thickness = 3
    polygon(window, circle, 5, 'orange', 5)

    circle = rg.Circle(rg.Point(300, 300), 250)
    circle.outline_thickness = 3
    polygon(window, circle, 4, 'purple', 5)

    circle = rg.Circle(rg.Point(300, 300), 250)
    circle.outline_thickness = 3
    circle.outline_color = 'lime green'
    polygon(window, circle, 3, 'red', 5)
...
def run_test_fancy_polygon():
    ...
    fancy_polygon(window, circle, 20, 25, 'red', 4)

    circle = rg.Circle(rg.Point(200, 200), 90)
    circle.fill_color = 'green'
    circle.outline_color = 'red'
    circle.outline_thickness = 3
    fancy_polygon(window, circle, 20, 25, 'red', 3)

    circle = rg.Circle(rg.Point(200, 200), 50)
    circle.fill_color = 'green'
    circle.outline_color = 'red'
    circle.outline_thickness = 2
    fancy_polygon(window, circle, 20, 25, 'red', 2)

    circle = rg.Circle(rg.Point(200, 200), 25)
    circle.fill_color = 'green'
    circle.outline_color = 'red'
    fancy_polygon(window, circle, 20, 25, 'red', 1)
    window.close_on_mouse_click()
