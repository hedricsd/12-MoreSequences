...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rect = rect + [rg.Rectangle(rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y + circles[k].radius), rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y - circles[k].radius))]
    return rect
